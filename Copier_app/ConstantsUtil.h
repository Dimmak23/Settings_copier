...
{
inline const QString defaultMessage =
	"Application designed and produced by DimmaK, 10 august 2022, all rights reserved.";
...
{
inline const std::string theseFiles =
	"These files and subdirectories were copied automatically using C++ "
	"script\nfrom ";
...
inline const QString SuccessLabel =
	R"(<span style=" font-size: 12pt; font-weight: 800; color: green;">Project template successfully copied...</span>)";
inline const QString SuccessQuestion =
	R"(<span style=" font-size: 10pt; font-weight: 600; color: green;">Do you want to set up another project?</span>)";

inline const char* PathErrorTitle = "ERROR";
inline const QString PathErrorLabel =
	R"(<span style=" font-size: 12pt; font-weight: 800; color: red;">Project with such name already exist!</span>)";
// inline const QString PathErrorMessage =
//	R"(<span style=" font-size: 10pt; font-weight: 600; color: red;">Advice: Please choose another name for the
//project.</span>)";
inline const QString DestIncompleateLabel =
	R"(<span style=" font-size: 12pt; font-weight: 800; color: red;">Incorrect path...</span>)";
inline const QString DestIncompleateMessage =
	R"(<span style=" text-width: 400px; font-size: 10pt; font-weight: 600; color: red;">Advice: Please follow information in the details<span>)";
inline const QString DestDetMessage =
	"Please start path with this pattern:\n[Disk_Name]:\\[Main_Folder]\\[Inner_Folder]\\...\\[Project_Name]";
